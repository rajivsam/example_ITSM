...
fp ="../data/plot_data_q2_2016_ticket_activity.csv"
...
app.layout = dbc.Container([
    dbc.Row(
                dbc.Col(html.H1('ITSM Ticket Resolution Activity Reports for Q2-2016', style={"text-align": 'center', "font-family": 'monospace'}), width=10), justify="center"),            
    dbc.Row([
